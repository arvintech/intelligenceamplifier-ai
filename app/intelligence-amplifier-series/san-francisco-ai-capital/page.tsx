      ...
      <main className="min-h-screen bg-[#f5f5f7] dark:bg-[#000000] pt-16">
            ...
            <div className="flex flex-col md:flex-row gap-8 items-start">
              ...
              <div className="flex-1">
                ...
                <p className="text-lg text-[#1d1d1f] dark:text-white leading-relaxed font-medium mb-6">
                  Explore the epicenter of artificial intelligence innovation. This book examines how San Francisco and Silicon Valley became the nexus of AI development.
                </p>
        ...
        <article className="py-16">
          <div className="max-w-3xl mx-auto px-6 sm:px-8 lg:px-12">
            <div className="prose prose-lg dark:prose-invert prose-headings:font-bold prose-headings:tracking-tight prose-a:text-[#007AFF] dark:prose-a:text-[#0A84FF] max-w-none">
