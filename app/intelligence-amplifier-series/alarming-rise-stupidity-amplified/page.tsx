...
export const metadata: Metadata = {
  title: 'Alarming Rise of Stupidity Amplified | Read Online',
  description: 'A critical examination of how AI can amplify human folly rather than wisdom.',
};

export default function AlarmingRiseStupidityAmplified() {
  return (
    <>
      <Navigation />
        ...
        <section className="relative py-16 border-b border-[#d2d2d7] dark:border-[#424245]">
          <div className="max-w-4xl mx-auto px-6 sm:px-8 lg:px-12">
            <Link 
              ...
              className="inline-flex items-center gap-2 text-[#FF9500] dark:text-[#FF9F0A] hover:underline font-medium mb-8"
            >
              ← Back to Series
            </Link>
            ...
            <div className="flex flex-col md:flex-row gap-8 items-start">
              ...
              <div className="w-64 md:w-80 flex-shrink-0">
                <div className="aspect-[2/3] rounded-[20px] overflow-hidden shadow-2xl">
                  <Image
                    ...
                    alt="Alarming Rise of Stupidity Amplified Book Cover"
                    width={400}
                    height={600}
              ...
              <div className="flex-1">
                <h1 className="text-4xl sm:text-5xl font-black text-[#000000] dark:text-white mb-4 tracking-tight leading-tight">
                  Alarming Rise of Stupidity Amplified
                </h1>
                <p className="text-xl text-[#FF9500] dark:text-[#FF9F0A] font-bold mb-6 uppercase tracking-wide">
                  Intelligence Amplifier Series - Book 2
                </p>
