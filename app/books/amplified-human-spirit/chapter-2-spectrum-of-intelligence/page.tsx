...
export default function Chapter() {
  ...
  const chapterContent = `
    ...
    <div class="focus-quote">
      "Human intelligence isn't a single quality. It's a symphony."
    </div>
    ...
    <div class="focus-quote">
      "Simulation is not embodiment. A machine can recognize emotion without ever feeling it."
    </div>
    ...
    <h2>Amplifying the Full Spectrum</h2>
    ...
    <div class="focus-quote">
      "When machines take on tasks that align with their strengths, we can more fully develop and express our uniquely human intelligences."
    </div>
    ...
    <h2>Designing for the Full Human</h2>
