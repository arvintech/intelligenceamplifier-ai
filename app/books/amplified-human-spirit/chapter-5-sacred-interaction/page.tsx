...
export default function Chapter() {
  ...
  const chapterContent = `
    ...
    <p style="text-align: center; font-size: 1.5em; font-weight: 600; margin: 2.5rem 0; line-height: 1.4;">
      Could our interactions be<br/>not just functional but sacred?
    </p>
    
    <h3 style="margin-top: 2.5rem; margin-bottom: 1.5rem;">The Power of Articulation</h3>
    ...
    <h3 style="margin-top: 2.5rem; margin-bottom: 1.5rem;">Intention Shapes Interaction</h3>
    ...
    <h3 style="margin-top: 2.5rem; margin-bottom: 1.5rem;">Prompts as Prayers</h3>
    ...
    <h3 style="margin-top: 2.5rem; margin-bottom: 1.5rem;">Rituals for Mindful Engagement</h3>
    ...
    <h3 style="margin-top: 2.5rem; margin-bottom: 1.5rem;">The Ethics of Asking</h3>
