...
export default function Chapter() {
  ...
  const chapterContent = `
    ...
    <h3 style="margin-top: 2.5rem; margin-bottom: 1.5rem;">External Memory and Knowledge Access</h3>
    ...
    <p style="text-align: center; font-size: 1.5em; font-weight: 600; margin: 2.5rem 0; line-height: 1.4;">
      These tools don't just store information.<br/>They transform how we think.
    </p>
    ...
    <h3 style="margin-top: 2.5rem; margin-bottom: 1.5rem;">Computational Augmentation</h3>
    ...
    <h3 style="margin-top: 2.5rem; margin-bottom: 1.5rem;">Assistive Technologies</h3>
    ...
    <h3 style="margin-top: 2.5rem; margin-bottom: 1.5rem;">Collaborative Intelligence</h3>
    ...
    <h3 style="margin-top: 2.5rem; margin-bottom: 1.5rem;">Artificial Intelligence as Amplifier</h3>
    ...
    <h3 style="margin-top: 2.5rem; margin-bottom: 1.5rem;">The Integration Challenge</h3>
