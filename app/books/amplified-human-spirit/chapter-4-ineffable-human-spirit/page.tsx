...
export default function Chapter() {
  ...
  const chapterContent = `
    ...
    <p style="text-align: center; font-size: 1.5em; font-weight: 600; margin: 2.5rem 0; line-height: 1.4;">
      What is it about being human<br/>that cannot be coded?
    </p>
    ...
    <h3 style="margin-top: 2.5rem; margin-bottom: 1.5rem;">Consciousness: The First-Person Experience</h3>
    ...
    <h3 style="margin-top: 2.5rem; margin-bottom: 1.5rem;">Intuition: Knowing Beyond Reason</h3>
    ...
    <h3 style="margin-top: 2.5rem; margin-bottom: 1.5rem;">Wisdom: The Integration of Knowledge and Virtue</h3>
    ...
    <h3 style="margin-top: 2.5rem; margin-bottom: 1.5rem;">Creativity: The Emergence of the Genuinely New</h3>
    ...
    <h3 style="margin-top: 2.5rem; margin-bottom: 1.5rem;">Spirit: The Essence of Being Human</h3>
    ...
    <h3 style="margin-top: 2.5rem; margin-bottom: 1.5rem;">Preserving the Ineffable</h3>
