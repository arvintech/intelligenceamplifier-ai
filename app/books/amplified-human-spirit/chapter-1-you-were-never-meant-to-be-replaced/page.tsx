...
export default function Chapter() {
  ...
  const chapterContent = `
    ...
    <div class="focus-quote">
      "The difference between replacing and amplifying"
    </div>
    ...
    <div class="focus-quote">
      "This competitive framing creates fear and resistance, and it fundamentally misunderstands the most promising path forward for human-machine relationships."
    </div>

    <h2>Intelligence Amplification vs Artificial Intelligence</h2>
    ...
    <h2>The Partnership Paradigm</h2>
    ...
    <div class="focus-quote">
      "The most transformative potential lies not in what machines can do instead of us, but in what we can do together."
    </div>
