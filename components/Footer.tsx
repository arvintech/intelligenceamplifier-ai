      ...
      <div className="max-w-5xl mx-auto px-6 sm:px-8 lg:px-12 py-16">
        <div className="text-center space-y-8">
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center justify-center gap-2 text-[13px] text-[#1d1d1f]/60 dark:text-white/60 font-normal">
          ...
          <div className="max-w-2xl mx-auto pt-6 border-t border-[var(--separator)] space-y-4">
