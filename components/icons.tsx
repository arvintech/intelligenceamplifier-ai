// Line icon components for macOS Tahoe-inspired design

export function Brain({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M9.5 2C8.96957 2 8.46086 2.21071 8.08579 2.58579C7.71071 2.96086 7.5 3.46957 7.5 4C7.5 4.53043 7.71071 5.03914 8.08579 5.41421C8.46086 5.78929 8.96957 6 9.5 6" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M14.5 2C15.0304 2 15.5391 2.21071 15.9142 2.58579C16.2893 2.96086 16.5 3.46957 16.5 4C16.5 4.53043 16.2893 5.03914 15.9142 5.41421C15.5391 5.78929 15.0304 6 14.5 6" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M12 2V6" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M12 6C13.5913 6 15.1174 6.63214 16.2426 7.75736C17.3679 8.88258 18 10.4087 18 12C18 13.5913 17.3679 15.1174 16.2426 16.2426C15.1174 17.3679 13.5913 18 12 18C10.4087 18 8.88258 17.3679 7.75736 16.2426C6.63214 15.1174 6 13.5913 6 12C6 10.4087 6.63214 8.88258 7.75736 7.75736C8.88258 6.63214 10.4087 6 12 6Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M12 18V22" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M9 12L10.5 13.5L12 12L13.5 13.5L15 12" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M9.5 15C9.5 15 10 16 12 16C14 16 14.5 15 14.5 15" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  );
}
...
export function Sparkles({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M19 12L19.75 14.25L22 15L19.75 15.75L19 18L18.25 15.75L16 15L18.25 14.25L19 12Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M6 18L6.75 20.25L9 21L6.75 21.75L6 24L5.25 21.75L3 21L5.25 20.25L6 18Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  );
}
...
export function BookStack({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M12 6L12 10M12 10L10 8M12 10L14 8" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  );
}
...
export function Library({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M3 6L9 2L15 6L21 2V18L15 22L9 18L3 22V6Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M9 2V18M15 6V22" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  );
}
...
export function Rocket({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M4.5 16.5C3 14 2.5 11.5 2.5 9C2.5 6.5 3.5 4 6 2C8.5 4.5 10 7.5 10 11L10 13L11 14L13 14L13 14C16.5 14 19.5 15.5 22 18C20 20.5 17.5 21.5 15 21.5C12.5 21.5 10 21 7.5 19.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
      <circle cx="15" cy="9" r="1.5" stroke="currentColor" strokeWidth="1.5"/>
      <path d="M11 14L7 18L5 22L9 20L13 16" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  );
}
...
export function Atom({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <circle cx="12" cy="12" r="1" stroke="currentColor" strokeWidth="1.5" fill="currentColor"/>
      <path d="M20.2 15.25C18.8 16.95 15.7 18 12 18C8.3 18 5.2 16.95 3.8 15.25C2.4 13.55 2.4 10.45 3.8 8.75C5.2 7.05 8.3 6 12 6C15.7 6 18.8 7.05 20.2 8.75C21.6 10.45 21.6 13.55 20.2 15.25Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
      <path d="M15.25 20.2C13.55 18.8 12.5 15.7 12.5 12C12.5 8.3 13.55 5.2 15.25 3.8C16.95 2.4 20.05 2.4 21.75 3.8C23.45 5.2 24.5 8.3 24.5 12C24.5 15.7 23.45 18.8 21.75 20.2C20.05 21.6 16.95 21.6 15.25 20.2Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" transform="translate(-0.5 0)"/>
      <path d="M8.75 20.2C10.45 18.8 11.5 15.7 11.5 12C11.5 8.3 10.45 5.2 8.75 3.8C7.05 2.4 3.95 2.4 2.25 3.8C0.55 5.2 -0.5 8.3 -0.5 12C-0.5 15.7 0.55 18.8 2.25 20.2C3.95 21.6 7.05 21.6 8.75 20.2Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" transform="translate(0.5 0)"/>
    </svg>
  );
}

// Food & Restaurant Icons
export function Rice({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M8 4V10M12 2V10M16 4V10" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
      <path d="M20 10H4C4 10 4 12 4 14C4 18 6 22 12 22C18 22 20 18 20 14C20 12 20 10 20 10Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M8 15C8 15 9 16 12 16C15 16 16 15 16 15" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
    </svg>
  );
}
...
export function ChefHat({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M6 13C4.67392 13 3.40215 12.4732 2.46447 11.5355C1.52678 10.5979 1 9.32608 1 8C1 6.67392 1.52678 5.40215 2.46447 4.46447C3.40215 3.52678 4.67392 3 6 3C6 3 6 3 8 3C8 1 10 1 12 1C14 1 16 1 16 3C18 3 18 3 18 3C19.3261 3 20.5979 3.52678 21.5355 4.46447C22.4732 5.40215 23 6.67392 23 8C23 9.32608 22.4732 10.5979 21.5355 11.5355C20.5979 12.4732 19.3261 13 18 13" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M6 13V20C6 21 6 22 7 22H17C18 22 18 21 18 20V13" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  );
}
...
export function WaveSound({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M2 10V14" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M6 6V18" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M10 3V21" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M14 8V16" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M18 10V14" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M22 12V12.01" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  );
}
...
export function Map({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M8 2V18M16 6V22" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  );
}
...
export function RefreshCw({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M20.49 9C19.9828 7.56678 19.1209 6.28536 17.9845 5.27542C16.8482 4.26548 15.4745 3.55976 13.9917 3.22426C12.5089 2.88875 10.9652 2.93433 9.50481 3.35677C8.04437 3.77921 6.71475 4.56471 5.64 5.64L1 10M23 14L18.36 18.36C17.2853 19.4353 15.9556 20.2208 14.4952 20.6432C13.0348 21.0657 11.4911 21.1112 10.0083 20.7757C8.52547 20.4402 7.1518 19.7345 6.01547 18.7246C4.87913 17.7146 4.01717 16.4332 3.51 15" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  );
}
...
export function Lightbulb({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M15 18H9M9 2C8.20435 2 7.44129 2.31607 6.87868 2.87868C6.31607 3.44129 6 4.20435 6 5C6 7.5 4 9 4 12C4 13.3261 4.52678 14.5979 5.46447 15.5355C6.40215 16.4732 7.67392 17 9 17H15C16.3261 17 17.5979 16.4732 18.5355 15.5355C19.4732 14.5979 20 13.3261 20 12C20 9 18 7.5 18 5C18 4.20435 17.6839 3.44129 17.1213 2.87868C16.5587 2.31607 15.7956 2 15 2H9Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
...
export function Eye({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M1 12S5 4 12 4C19 4 23 12 23 12S19 20 12 20C5 20 1 12 1 12Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
